...
export const SP_ENTITY_ID = `${SP_ORIGIN}/metadata`;
// Assertion Consumer Service: the SP endpoint the IdP POSTs the response to.
export const SP_ACS_URL = `${SP_ORIGIN}/acs`;

// --- Identity Provider identity --------------------------------------------
export const IDP_ENTITY_ID = `${IDP_ORIGIN}/metadata`;
// Single Sign-On service: where the SP sends users to authenticate.
export const IDP_SSO_URL = `${IDP_ORIGIN}/sso`;
